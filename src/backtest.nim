...
when isMainModule:
  ...
  show("time", "profit (%)", 0,
    ...
    (toSeq(50..local_optimization.len + 49), local_optimization, "Local Optimization"),
    (toSeq(20..price_spring.len + 19), price_spring, "Price Spring"),
  )
